...
export default function SignUp() {
  ...
  const handleGoogleSignUp = () => {
    ...
    const authUrlParams = {
      ...
      nonce: nanoid(19),
      prompt: "consent",
      state: btoa(JSON.stringify({ intent: "SIGN_UP" })),
    }
        ...
        <CardRoot
          ...
          contentChildren={
            <div className="flex flex-col items-center gap-4">
              ...
              <p className="mt-2 text-sm text-gray-500">Click the link in your email to create your account.</p>
            </div>
          }
          footerChildren={
  ...
  return (
    <div className="bg-background flex min-h-screen flex-col items-center justify-center px-4 sm:px-6">
      <CardRoot
        ...
        descriptionChildren="Enter your information below to create your ClassyNotes account"
